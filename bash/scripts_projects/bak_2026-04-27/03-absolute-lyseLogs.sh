...
find /home/student/projects/git/devops-journey/bash/logs -name "*.log" -mtime -1

echo -e "\n* Number of ERROR logs found in application.log"
grep -c "ERROR" /home/student/projects/git/devops-journey/bash/logs/application.log

echo -e "\n* Number of FATAL logs found in application.log"
grep -c "FATAL" /home/student/projects/git/devops-journey/bash/logs/application.log

echo -e "\n* Searching ERROR logs in application.log file..."
grep "ERROR" /home/student/projects/git/devops-journey/bash/logs/application.log

echo -e "\n* Number of FATAL logs found in system.log"
grep -c "FATAL" /home/student/projects/git/devops-journey/bash/logs/system.log

echo -e "\n* Number of CRITICAL logs found in system.log"
grep -c "CRITICAL" /home/student/projects/git/devops-journey/bash/logs/system.log

echo -e "\n* Searching CRITICAL logs in application.log file..."
grep "CRITICAL" /home/student/projects/git/devops-journey/bash/logs/system.log
...
/home/student/projects/git/devops-journey/bash/logs/application.log
/home/student/projects/git/devops-journey/bash/logs/system.log

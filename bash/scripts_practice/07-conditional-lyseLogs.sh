...
for LOG_FILE in $LOG_FILES; do
    ...
    for PATTERN in ${ERROR_PATTERNS[@]}; do
        ...
        if [ "$ERROR_COUNT" -gt 10 ]; then
            echo -e "\n*** Action Required: too many $PATTERN errors in logfile $LOG_FILE ***" 
        fi
    done
done
...
*** Action Required: too many ERROR errors in logfile /home/student/projects/git/devops-journey/bash/logs/system.log ***

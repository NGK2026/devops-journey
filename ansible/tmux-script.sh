...
tmux new-window -t $SESSION:3 -n 'ubu-22-srv3'
tmux new-window -t $SESSION:4 -n 'ubu-26-srv4'
tmux new-window -t $SESSION:5 -n 'ubu-26-srv5'
tmux new-window -t $SESSION:6 -n 'cent-srv6'
...
tmux send-keys -t $SESSION:3 'ssh 192.168.0.139' C-m 
tmux send-keys -t $SESSION:4 'ssh 192.168.0.3' C-m
tmux send-keys -t $SESSION:5 'ssh 192.168.0.66' C-m
tmux send-keys -t $SESSION:6 'ssh 192.168.0.171' C-m

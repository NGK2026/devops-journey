...
```
10. Create VPC (Isolated cloud resource): - https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/instance#example-usage
```tf
resource "aws_vpc" "main" {
  cidr_block = "10.0.0.0/16"
}
```
11. Create subnet: - https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/subnet
```tf

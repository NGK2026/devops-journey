...
# creates:
# .terraform folder includes licence.txt and necessary provider plugins
# terraform.tfstate: JSON - keeps track of everything created
terraform init
...
```
#### NB: Use auto approve to skip 'yes' confirmation
```sh

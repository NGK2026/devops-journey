...
- [Terraform](#terraform)
  ...
  - [Check Authentication and Configuration "AWS"](#check-authentication-and-configuration-aws)
  - [Basic syntax to create resource for provider eg](#basic-syntax-to-create-resource-for-provider-eg)
  - [Create EC2 instance](#create-ec2-instance)
  - [Create VPC (Isolated cloud resource)](#create-vpc-isolated-cloud-resource)
  - [Create Subnet](#create-subnet)
  - [Create Internet gateway](#create-internet-gateway)
  - [Create Route Table](#create-route-table)
  - [Availability Zones](#availability-zones)
  - [Create Route Table Association](#create-route-table-association)
  - [Create Security Group](#create-security-group)
  - [Create Network Interface](#create-network-interface)
  - [Create Elastic IP 'EIP'](#create-elastic-ip-eip)
